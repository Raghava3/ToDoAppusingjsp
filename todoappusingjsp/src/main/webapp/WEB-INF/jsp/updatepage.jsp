...
<font color="white"><b> <h4>Todo</h4></b></font>
  ...
  <div class="dd">
<table> 
<form action="addNotes1" method="get" style="padding:30px">
<tr>
<td>
...
<%-- </div>
     <c:forEach items="${updatenote}" var="updatedata">
     <div class="note">
     <table>
<tr><td>title:<c:out value="${updatedata.title}"/></td></tr>
<tr><td>description: <c:out value="${updatedata.description}"/></td></tr>
<tr><td><a href="<c:url value='deleteNote?id=${updatedata.id}'/>">delete Note</a>
